  ...
  server = function(input, output, session) {
    ...
    observe({
      ...
      if(!is.null(input$selected_model)){
        file_selected <- shinyFiles::shinyFileChoose(roots, input$selected_model)
    ...
    observe({ 
      ...
      if(!is.null(input$selected_metadata)){
        file_selected <- shinyFiles::shinyFileChoose(roots, input$selected_metadata)
...
# 2) Panel fit model ------------------------------------------------------
    ...
    #     file_selected <- shinyFiles::shinyFileChoose(roots, input$rdata_path)
    ...
    #     file_selected <- shinyFiles::shinyFileChoose(roots, input$model_path)
