...
```
NOTE TO NEW USERS - Please install miniconda (or similar) before installing soundClass in R: https://docs.conda.io/en/latest/miniconda.html 
...
```{r model_deploy, eval = F, echo = T}
   auto_id(model_path = "./fitted_model.hdf5",
          metadata = metadata,
          file_path = "~/data_example/training_recordings",
          out_file = "id_results",
          out_dir = "output/",
          save_png = TRUE,          
          win_size = 40,
