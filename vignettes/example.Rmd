...
```
NOTE TO NEW USERS - Please install miniconda before using soundClass package: https://docs.conda.io/en/latest/miniconda.html 
...
Please note that before using soundClass for the first time it is necessary to have tensorflow and keras backend installed. This can be achieved by running the function install_keras():   
...
save(train_calls, "train_calls.RDATA")
```
