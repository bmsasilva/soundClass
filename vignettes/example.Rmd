...
```
Before installing soundClass it is necessary to install keras package, which in turn will install tensorflow. After installing keras, load it and run function install_keras():   
