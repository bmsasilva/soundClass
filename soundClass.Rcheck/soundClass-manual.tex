...
\end{Author}
\inputencoding{utf8}
\HeaderA{butter\_filter}{Apply a buttterworth filter to sound samples}{butter.Rul.filter}
%
\begin{Description}\relax
Apply a buttterworth filter, high pass or/and low pass,
to sound samples. Based on the function \LinkA{butter}{butter}
\end{Description}
%
\begin{Usage}
\begin{verbatim}
...
\end{Examples}
\inputencoding{utf8}
\HeaderA{spectro\_calls}{Generates spectrograms from recording labels.}{spectro.Rul.calls}
%
\begin{Description}\relax
...
\end{Author}
\inputencoding{utf8}
\HeaderA{train\_data\_process}{Process train data for Keras format}{train.Rul.data.Rul.process}
%
\begin{Description}\relax
