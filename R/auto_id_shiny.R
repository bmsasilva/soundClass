...
#' @param model_path An object of class 'recording', created with
...
#' as png file? 
#' @param remove_noise = T, Logical. TRUE indicates that the model was fitted
