...
#' the mean of each frequency column to all rows of that column. Please note
#' that columns must represent frequency and rows must represent time.
#' Energy values are afterwards standartized to min = 0 and max = 1
#' by dividing by maximum energy value of the spectrogram matrix.
