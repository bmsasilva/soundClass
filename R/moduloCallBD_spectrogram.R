...
Spectrogram = function( 
  ...
  # time across the rows and frequency across the columns
  ...
  # [15]
  # Maximum intensity for spectrogram normalization (in dB)
  norm = 140
  ...
  # Normalize the spectrogram matrix by making the highest value to be input 'norm'
  ...
  if(plot==FALSE){
    ...
    # Convert FrequencySequence to kHz for the plot axis
...
batsound<-rev(c("#00001F","#00002F","#00003F","#00004F","#00005F",
